...
\begin{document}
  ...
  \end{center}
	\begin{tabular}{l l l l}
		\textbf{Course Number:} & CS179.14A\\
		\textbf{Title:} & \multicolumn{3}{l}{Special Topics in Multimedia: PC and Console Game Development I}\\
		\textbf{Department/Program:} & DISCS & \textbf{School:} & School of Science and Engineering\\
		\textbf{Semester:} & 1\textsuperscript{st} & \textbf{School Year:} & 2015-2016\\
		\textbf{Instructor/s:} & \multicolumn{3}{l}{Wilhansen Joseph B. Li <\url{wil+cs179.14a@byimplication.com}>} \\
		\textbf{Course Website:} & \multicolumn{3}{l}{\url{http://moodle.ateneo.edu/ls/course/view.php?id=258}}
	\end{tabular}
...
\item Courseware (for announcements, quizzes, etc.): \url{http://moodle.ateneo.edu/ls/course/view.php?id=258}
\item Syllabus: \url{https://github.com/CS179-14A-2015-2016/syllabus}
\item Course Github Organization: \url{https://github.com/CS179-14A-2015-2016}
...
\item The project consultation is two parts, contributing 2.5\% each, the first is to be done anytime before week 9 and the second is to be done before the finals week.
